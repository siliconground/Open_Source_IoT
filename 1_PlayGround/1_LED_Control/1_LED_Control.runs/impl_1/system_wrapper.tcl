namespace eval ::optrace {
  variable script "D:/xilinx_project/zync7000_test/Open_Source_IoT/1_PlayGround/1_LED_Control/1_LED_Control.runs/impl_1/system_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir D:/xilinx_project/zync7000_test/Open_Source_IoT/1_PlayGround/1_LED_Control/1_LED_Control.cache/wt [current_project]
  set_property parent.project_path D:/xilinx_project/zync7000_test/Open_Source_IoT/1_PlayGround/1_LED_Control/1_LED_Control.xpr [current_project]
  set_property ip_output_repo D:/xilinx_project/zync7000_test/Open_Source_IoT/1_PlayGround/1_LED_Control/1_LED_Control.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet D:/xilinx_project/zync7000_test/Open_Source_IoT/1_PlayGround/1_LED_Control/1_LED_Control.runs/synth_1/system_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files D:/xilinx_project/zync7000_test/Open_Source_IoT/1_PlayGround/1_LED_Control/1_LED_Control.srcs/sources_1/bd/system/system.bd
